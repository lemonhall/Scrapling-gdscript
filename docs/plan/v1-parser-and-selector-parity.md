...
- 2026-03-08 Green 7: `powershell -File scripts/run_godot_tests.ps1 -Suite parser` → `PASS` / exit code `0` (smoke + navigation + text search + regex extract + content access + find_similar + find/find_all)
- 2026-03-08 Red 8: `powershell -File scripts/run_godot_tests.ps1 -Suite parser` → `_init expected 3 argument(s), called with 4` (adaptive constructor gap)
- 2026-03-08 Green 8: `powershell -File scripts/run_godot_tests.ps1 -Suite parser` → `PASS` / exit code `0` (adaptive relocation added)
