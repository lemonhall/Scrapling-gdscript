...
| REQ-0001-005 | `PRD-0001` | `v1-static-fetcher-and-session-parity.md` | `fetchers-static` | FetcherSession cookie PASS 2026-03-08 | in_progress |
...
- 当前仓库已具备 parser 核心等价层，以及静态 fetcher 的 GET / POST / PUT / DELETE / headers / params 最小实现，并已打通 `FetcherSession` 的 cookie 持久化；proxy、显式 cookies API、browser、spider、tooling 仍待推进。
