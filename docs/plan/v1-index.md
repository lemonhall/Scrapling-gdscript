...
| M1 | 建立 `Godot 4.6` 工程脚手架与 headless 测试入口 | `powershell -File scripts/run_godot_tests.ps1 -Suite foundation` | todo |
...
|---|---|---|---|---|---|
| REQ-0001-001 | `PRD-0001` | `v1-parser-and-selector-parity.md` | `parser` | — | todo |
| REQ-0001-002 | `PRD-0001` | `v1-parser-and-selector-parity.md` | `parser` | — | todo |
| REQ-0001-003 | `PRD-0001` | `v1-parser-and-selector-parity.md` | `parser` | — | todo |
...
| REQ-0001-012 | `PRD-0001` | `v1-godot-foundation.md` | `foundation` | — | todo |
...
- 当前仓库尚无 `project.godot`。
- 当前仓库尚无 `addons/scrapling/` 实现。
- 当前仓库尚无 `tests/`、`scripts/run_godot_tests.ps1`、fixtures、示例。
- 所有需求均处于 `todo`，当前仅完成文档基线与计划拆解。
